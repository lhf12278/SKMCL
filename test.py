...
parser.add_argument('--resume', '-r', default='sysu_n_4_b_6_lr_0.1_aa_0.4_bb_0.01_cc_0.4_dd_1.0_best.t', type=str, help='resume from checkpoint')
...
net = embed_net(args.low_dim, n_class, drop=args.drop, part=args.part, arch=args.arch, wpa=args.wpa, load_batch=24)
net.to(device)
